...
// ── CONFIGURATION ──────────────────────────────────────────
const CONFIG = {
  name: "Fafa", // Ganti dengan nama yang berulang tahun
  nickname: "Fafa", // Nama panggilan untuk teks tertentu
...
function setupConfig() {
  ...
  if (calSpecial) calSpecial.textContent = `${CONFIG.specialDay} 💌`;
}
...
function openGift() {
  ...
  setTimeout(() => {
    giftSection.style.animation = "sectionShake 0.4s ease";
  }, 10);
